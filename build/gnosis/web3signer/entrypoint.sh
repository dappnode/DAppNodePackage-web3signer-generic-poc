...
export WEB3SIGNER_API="http://web3signer.web3signer-gnosis.dappnode:9000"
...
exec /opt/web3signer/bin/web3signer \
  ...
  --http-host-allowlist="web3signer.web3signer-gnosis.dappnode,ui.web3signer-gnosis.dappnode,prysm.migration-gnosis.dappnode,$ETH2_CLIENT_DNS" \
  --http-cors-origins=* \
